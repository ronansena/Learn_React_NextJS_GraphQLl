...
import { UPDATE_ORIGEM_DADO_NUTRICIONAL } from "../../../../../queries/TabelaNutricional/OrigemDadoNutricional";
...
const ChangeOrigemDadoNutricional = ({
  showMessage,
  setRowsDataTemp,
  rowsDataTemp,
  idSelectRow,
  ...
  linkFonteSelectRow
}: { showMessage: any, setRowsDataTemp: any, rowsDataTemp: any, idSelectRow: number, nomeOrigemDadoNutricionalSelectRow: string,linkFonteSelectRow:string }
) => {

  //console.log(idSelectRow);
  // console.log(nomeOrigemDadoNutricionalSelectRow);
  ...
  const [updateOrigemDadoNutricionalPage] = useMutation(UPDATE_ORIGEM_DADO_NUTRICIONAL);
  ...
  }, [open2,idSelectRow, linkFonteSelectRow, nomeOrigemDadoNutricionalSelectRow]);
...
export default ChangeOrigemDadoNutricional;
